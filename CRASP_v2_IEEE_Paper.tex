...
\thanks{Code and data available at: \url{https://github.com/jenahkarthickp/crasp-v2}}}
...
The full CRASP v2 implementation---including the synthetic data generation
pipeline (\texttt{src/generate\_data.py}), model training code
(\texttt{src/train\_models.py}), the Streamlit dashboard, and this
manuscript's \LaTeX{} source---is publicly available at
\url{https://github.com/jenahkarthickp/crasp-v2}.
